...
[22] dnsutils
[23] coreutils ''')
choice = input("\033[93m\nDo You Want to Install All Packages [y/n] : ")
if choice == 'n' : sys.exit()
if choice == 'y' : print ("Allow the Button For Access the Storage in Termux")
